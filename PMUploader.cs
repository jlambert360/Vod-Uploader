    ...
    class PMUploader
    {
        ...
        static void Main(string[] args)
        {
            ...
            var myFile = directory.GetFiles()
             ...
             .First();
            Console.Title = "PM Vod Uploader Version " + version;
            Console.WriteLine("~~~PM Vod Uploader by Bird~~~");
            Console.WriteLine("==============================");
        ...
        private async Task Run()
        {
            ...
            //Loads the output for Scoreboard Assistant and makes a title out of Player1 vs. Player2 and the match type
                ...
                for (int i = 0; i < player1.Count; i++)
                {
                    ...
                    Console.WriteLine("Project M Uploader: Video title is " + player1[i].InnerXml + " vs. " + player2[i].InnerXml + " " + match[i].InnerXml);
                }
                

            video.Snippet.Description = descriptionText;
            
            video.Snippet.Tags = new string[] { SMASH_KEYWORDS + "\t" + tagsText + "\t" + PM_KEYWORDS };
