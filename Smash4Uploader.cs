...
namespace Smash4_Uploader
{
    class Smash4Uploader
    {
        ...
        static void Main(string[] args)
        {
            ...
            var myFile = directory.GetFiles()
             ...
             .First();
            Console.Title = "Smash 4 Vod Uploader Version " + version;
            Console.WriteLine("~~~Smash 4 Vod Uploader by Bird~~~");
            Console.WriteLine("==============================");
        ...
        private async Task Run()
        {
            ...
            for (int i = 0; i < player1.Count; i++)
            {
                ...
                Console.WriteLine("Smash 4 Uploader: Video title is " + player1[i].InnerXml + " vs. " + player2[i].InnerXml + " " + match[i].InnerXml);
            }


            video.Snippet.Description = descriptionText;

            video.Snippet.Tags = new string[] { SMASH_KEYWORDS + "\t" + tagsText + "\t" + SMASH4_KEYWORDS };
